...
https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/40/Everything/aarch64/os/Packages/p/python3-bitarray-2.8.5-3.fc40.aarch64.rpm \
"

RDEPENDS = "xcp-ng-release"
